%this program to get sbox value
...
RowIndexOfSBox=ZIn6BitFormat(1)*2^0+ZIn6BitFormat(6)*2^1+1;
ColIndexOfSBox=ZIn6BitFormat(2)*2^0+ZIn6BitFormat(3)*2^1+ZIn6BitFormat(4)*2^2+ZIn6BitFormat(5)*2^3+1;
Temp=SBox(RowIndexOfSBox,ColIndexOfSBox,IndexOfZ);        
SValue=bitget(Temp,1:4);
