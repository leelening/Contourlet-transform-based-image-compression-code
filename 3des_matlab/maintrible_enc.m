...
%01 23 45 67 89ab cdef
asci=[1,35,69,103,137,171,205,239];
for i=1:8
...
% asci=double(y);%convert from char to asciicode
%fedc ba98 7654 3210
asci=[254,220,186,152,118,84,50,16];
for i=1:8
...
temp=Data;
A=trible_enc(temp,kf1);
temp=A;
B=trible_dec(temp,kf2);
temp=B;
C=trible_enc(temp,kf1);
w=C;
DecryptedCharacters=[];
for i=1:8
...
file = fopen('c:\Encryptedfile.txt','w+');%create and open file
